...
const Modal = ({ isVisible, onClose, children, position }: ModalProps) => {
  ...
  return (
    <div
      className="modal fade fixed inset-0 bg-black bg-opacity-50 flex flex-col justify-end items-center z-50 left-0 top-0 gap-4 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500
