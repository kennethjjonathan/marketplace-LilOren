  ...
  return (
    <form className="bg-white pb-[100px]" onSubmit={handleSubmit}>
      ...
      <div className={styles.button_wrapper}>
        <Button
          disabled={!Object.values(shopInfoFormData).every((val) => val !== '')}
          className="w-full"
          type="submit"
          variant={'default'}
        >
...
const SellerOnboardingFormHeading = () => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden SellerOnboardingForm__navbar w-[100%] min-w-auto flex justify-between items-center top-0 h-[52px] border-b-[1px] sticky bg-white">
        <BackButton
        ...
        <div className="mx-4">
          <p className="user__address__heading block relative font-medium m-0 text-[16px] text-primary">
            {'Save'}
          </p>
        </div>
      </div>
