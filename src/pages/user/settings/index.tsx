...
const UserEditAddress: NextPageWithLayout = () => {
  return <div>Edit Address</div>;
};

const UserInfoSettingsHeading = () => {
  ...
  return (
    <>
      ...
      <div className="lg:hidden UserInfoSettings__navbar w-[100%] min-w-auto flex items-center top-0 h-[52px] border-b-[1px] sticky bg-white">
        <BackButton
...
UserEditAddress.getLayout = function getLayout(page: ReactElement) {
  return (
    <UserSettingsLayout
      currentTab="Edit Address"
      component={<UserInfoSettingsHeading />}
    >
      {page}
    </UserSettingsLayout>
  );
